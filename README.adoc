...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/Almoura/sistema-bancario-java-junit/maven[GitHub Workflow Status]
